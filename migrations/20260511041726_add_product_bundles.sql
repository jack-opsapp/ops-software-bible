...
-- Match existing OPS RLS pattern: simple company isolation. Permission gating
-- happens at the iOS/web client level via permission_store. See
-- ops-software-bible/03_DATA_ARCHITECTURE.md for the convention.
