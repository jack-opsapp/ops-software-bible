...
>
> **Web correction implemented (2026-07-05, bug `af27ea82` part b).** The web side now honors this table two ways, both on branch `claude/fervent-swirles-d06ecc` (pending Jackson's deploy + migration apply):
