...
| Prompt | canonical copy in `ops-web/docs/ads/engine-routine.md`, version `ads-routine-2026-09-14-v3` (routine updated 2026-09-14; competitor names only where the brief's ad group `copyKind` is `competitor`); edit there first, then `/schedule update` |
