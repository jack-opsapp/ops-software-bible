...
Source: OPS-Web commit `deb093ebc`. The three migrations named below are mirrored byte-for-byte in this Bible but are **not production-applied**. Their runtime contract has been exercised on disposable PostgreSQL 17.
