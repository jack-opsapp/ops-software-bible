...
class Activity: Identifiable {
    ...
    // site_visit_id   UUID FK site_visits          — parent for a completed-site-visit activity; nullable. Written by legacy CreateActivityDTO and decoded on iOS since SwiftData V21; durable site-visit sync writes it only through complete_site_visit_guarded.
