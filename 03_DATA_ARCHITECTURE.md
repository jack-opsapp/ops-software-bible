...
## Phase 19 site-visit shared writes and proposals (2026-09-10; local, unapplied)
...
Parent integration on 2026-09-11 verified all six SQL source/mirror hashes unchanged and all27 historical fingerprint entries intact. Phone merge `187a36d6`, with evidence `35d40210`, is on local iOS main after a single app-hosted run: 138 passed, two optional private-store-copy tests skipped, zero failures. Runtime checks include every released fingerprint and the populated V27→V28 independent reopen preserving original pending-work custody and nil new metadata. This is local compatibility proof; the six SQL migrations remain unapplied and company compatibility/effect policies remain unactivated.

Unapplied source migrations: `20260910190020_site_visit_concurrency_protocol.sql`, `20260910191043_site_visit_durable_writes.sql`, `20260910204942_site_visit_canonical_actor_booking.sql`, `20260910205717_agent_site_visit_workflow.sql`, `20260911010000_site_visit_workflow_rate_limit.sql`, `20260911011000_site_visit_packet_discard.sql`. See the [implementation contract](specs/2026-09-10-ops-mcp-site-visits-p19-implementation.md) and final phase handoff for exact hashes, compatibility requirements, testing and release boundaries. This section does not supersede the earlier production-live booking/completion contract until release is explicitly recorded.
