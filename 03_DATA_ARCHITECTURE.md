...
OPS-Web migration `supabase/migrations/20260820220000_agent_discovery_reads.sql` is complete on isolated branch `feat/mcp-discovery-reads` but is **not applied to any OPS catalog**. Its frozen SHA-256 is `92416045d100971f9ce4b890de57881e421bf05c8867b11a5aebab5b7afda72d`.
