...
### 22C-1. Guarded visit stage storage (2026-09-06; locally prepared, unapplied)

Source: `ops-web/supabase/migrations/20260906171832_site_visit_stage_commands.sql`, isolated branch `codex/ios-performance-p1-5`, final commit `26816f355f55807232c8c9f8cb3b406d4314d948` (following `caec2dfa` and `e95d12a0`). This additive migration has **not** been applied to `ops-app` and is intentionally absent from the archive of applied migrations. No public opportunity column or SwiftData field is added by this server contract.
