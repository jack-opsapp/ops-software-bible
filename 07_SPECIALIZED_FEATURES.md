...
OPS-Web commits `237d151aba2a1ca28b349c5596b8e8ba2b56642c`, `9006d343d4dc10d3724b5627bfa26fa0d4a1eb7a` and shared integration `1ecd310fda5110f8ef329e3229a4497ce23b39ed` add a host-neutral geometry result v2. The full V14-equivalent V23 successor is locally integrated by `7788200d8` and `6bc665097`, including guarded database compatibility; it is not yet deployed or accepted in Claude. The strict v1 result remains a separate representation; see the API chapter's dated MCP deck geometry section for compatibility, authorization, full successor exposure and release gates.
