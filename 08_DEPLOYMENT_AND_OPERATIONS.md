...
**Provider-health rollout record (2026-08-05):** the database-first migration was applied and read back before OPS-Web commit `146f6d69c4d52d985bc516c0453db6590f92cf97` was promoted as READY production deployment `dpl_6gxJ4P8dv7ohpXpi1wbbdPuyR7FY`. Runtime proof drained the derived continuation from seven pending opportunity IDs to zero. Subsequent live readback showed latest `last_synced_at` `2026-08-05T19:22:36.949Z` and latest `provider_snapshot_at` `2026-08-05T19:22:37.018404Z`. The customer domain was later superseded by READY main deployment `dpl_2pmEULv4sbwCwjB4HbPd8XY9ofgh` at `d34427922cafda3fb17769a044941a6b6218ac64`; that commit is a sibling of `146f6d69` and does not contain the repair. The production database contract remains live, but the customer-domain web code is not durably released. Integrate `146f6d69` onto current `origin/main` (`d3442792`), rerun the relevant gates, push/deploy main, and repeat customer-domain checkpoint, queue-drain, timestamp, and heartbeat proof. Do not reapply the migration.
